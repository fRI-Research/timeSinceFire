...
df_inputs <- SpaDES.core::moduleInputs("timeSinceFire", "/tmp/RtmpXeMbR7")
...
df_params <- SpaDES.core::moduleParams("timeSinceFire", "/tmp/RtmpXeMbR7")
...
df_outputs <- SpaDES.core::moduleOutputs("timeSinceFire", "/tmp/RtmpXeMbR7")
